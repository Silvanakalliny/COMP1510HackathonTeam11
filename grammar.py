...
def run_test(question_bank: dict, test: str):
    ...
    for n, question in enumerate(questions, 1):
        ...
        # if the test is a verb conjugation test, it prints out the two options: correct and incorrect
        if test == "verbs":
            print("""   1. Correct\n   2. Incorrect""")
        # if the user is doing the present simple test, the three MC options are printed to the user
    ...
    # prints the user's actual score and the highest possible score.
